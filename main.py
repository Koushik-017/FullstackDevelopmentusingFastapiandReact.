...
from models1 import (supplier_pydantic,supplier_pydanticIn,Supplier,product_pydanticIn,product_pydantic,Product)
...
async def fetch_all_suppliers():
   #it will return all suppliers
   response=await supplier_pydantic.from_queryset(Supplier.all())
   return {"status":"OK","data":response}


@app.get('/supplier/{supplier_id}')
async def fetch_specific_supplier(supplier_id:int ):
...
async  def add_products(supplier_id:int,products_details:product_pydanticIn):
    supplier = await Supplier.get(id = supplier_id)
...
async def get_all_products():
   ...
   return {"status":"o(K","data":response}
...
#     MAIL_USERNAME ="koushikkgowda017@gmail.com",
#     MAIL_PASSWORD = "**********",
#     MAIL_FROM = "koushikkgowda017@gmail.com",
#     MAIL_PORT = 465,
...
#   #usinf product we can fetch supplier
